...
\ save creates the memory.h file, which defines an array of
\ 16 bit words in ROM. This is the Forth virtual machine memory.
\ RAM is defined separately.
: save  (  - )
    ...
    crlf
    s" const uint16_t PROGMEM memory[] = {" spit crlf
    crlf
